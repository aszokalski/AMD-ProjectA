...
FUNGIDATA_API_HOST = os.getenv("FUNGIDATA_API_HOST", "localhost")
FUNGIDATA_API_PORT = os.getenv("FUNGIDATA_API_PORT", "8000")
FUNGIDATA_API_URL = f"http://{FUNGIDATA_API_HOST}:{FUNGIDATA_API_PORT}"
